...
function gerarPDF() {
    ...
    var docDefinition = {
        ...
        content: [
            ...
            {
                text: 'Declaro para os devidos fins, em nome da [identificação da organização da sociedade civil — OSC], nos termos dos art. 26, caput, inciso VII e art. 27 do Decreto nº 8.726, de 2016, e art. 39, incisos III ao VII, da Lei nº 13.019, de 2014, que os seus dirigentes abaixo relacionados, a saber:',
                margin: [0, 0, 0, 10],
                alignment: 'justify'
            },
            ...
            // Tabela dos dirigentes
            {
                table: {
                    headerRows: 1,
                    widths: ['30%', '35%', '35%'], // Ajuste das colunas
                    body: [
                        [
                            { text: 'Nome do dirigente e cargo que ocupa na OSC', bold: true, alignment: 'center', fontSize: 10 },
            ...
            { text: 'V – não tiveram as contas rejeitadas pela Administração Pública nos últimos cinco anos ou', margin: [0, 10], alignment: 'justify' },
            { text: '   tiveram as contas rejeitadas, mas demonstraram, nos termos do art. 39, IV, alíneas "a", "b" e "c", da Lei nº 13.019, de 2014, que:', margin: [0, 10], alignment: 'justify', color: 'red' },
            { text: 'V.1 – a irregularidade que motivou a rejeição das contas foi sanada e que os débitos eventualmente imputados foram quitados;', margin: [10, 5], alignment: 'justify', color: 'red' },
            { text: 'V.2 – a decisão de rejeição das contas foi reconsiderada ou revista;', margin: [10, 5], alignment: 'justify', color: 'red' },
            { text: 'V.3 – a decisão sobre a apreciação das contas está pendente de decisão sobre recurso com efeito suspensivo;', margin: [10, 5], alignment: 'justify', color: 'red' },
            ...
            { text: 'c) foram considerados responsáveis por ato de improbidade ou foram considerados responsáveis por ato de improbidade, mas os respectivos efeitos, nos prazos previstos no art. 12, incisos I, II e III, da Lei nº 8.429, de 1992, já se exauriram.', margin: [10, 5], alignment: 'justify' },
